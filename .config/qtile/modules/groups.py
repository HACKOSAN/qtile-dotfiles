...
workspaces = [
    ...
    {"name": workspace_names[1], "key": "2", "matches": [Match(wm_class="code")], "lay": "monadtall"},
    ...
    {"name": workspace_names[6], "key": "7", "matches": [Match(wm_class="burp")], "lay": "bsp"},
    {"name": workspace_names[7], "key": "8", "matches": [], "lay": "bsp"},
    {"name": workspace_names[8], "key": "9", "matches": [], "lay": "bsp"},
]
