...
keys = [
    ...
    # rofi
    Key([mod], "e", lazy.spawn("rofi -show drun -theme ~/.config/rofi/launchers/type-2/lukka.rasi"), desc="Launch Rofi"),
    Key([mod, shift], "e", lazy.spawn("/home/lukka/.config/rofi/powermenu/type-2/powermenu.sh"), desc="Power Menu"),
    Key([mod, shift], "s", lazy.spawn("/home/lukka/.config/rofi/applets/bin/mpd.sh"), desc="Music Player Menu"),
    ...
    Key([mod], "f", lazy.spawn("firefox-nightly"), desc="Launch Firefox"),
